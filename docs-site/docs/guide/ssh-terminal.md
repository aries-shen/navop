...
Agent Hub 不是单独的终端截图，而是由终端 Agent、工作区资源管理器、Git 更改列表、分支管理和并排 Diff 共同组成的完整功能。它采用成熟 Agent 编程工具中常见的组合式工作区，让代码执行、文件定位和修改审核保持在同一上下文，同时可以直接结合 Navop 的本地终端、SSH 会话和连接资源。
...
![Agent Hub 并排差异](/images/git_diff.png)
