(component
  (type $ui-instance
    (instance
      (type (;0;) (record (field "extension-id" string) (field "command-id" string) (field "node-id" string) (field "node-name" string) (field "node-type" string) (field "database-type" string) (field "connection-id" string)))
      (export (;1;) "action-context" (type (eq 0)))
      (type (;2;) (enum "info" "success" "warning" "error"))
      (export (;3;) "notification-level" (type (eq 2)))
      (type (;4;) (func (param "level" 3) (param "title" string) (param "message" string)))
      (export (;0;) "notify" (func (type 4)))
      (type (;5;) (option 1))
      (type (;6;) (func (result 5)))
      (export (;1;) "current-action-context" (func (type 6)))
      (type (;7;) (func (param "connection-id" string)))
      (export (;2;) "refresh-tree" (func (type 7)))
    )
  )
